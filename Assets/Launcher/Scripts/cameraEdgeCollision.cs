...
public class CameraEdgeCollision : MonoBehaviour
{
    ...
    public void AddColliderOnCamera()
    {
        if (Camera.main == null)
        {
            UnityEngine.Debug.LogError("No camera found make sure you have tagged your camera with 'MainCamera'");
            return;
        }
        ...
        if (!cam.orthographic)
        {
            UnityEngine.Debug.LogError("Make sure your camera is set to orthographic");
            return;
        }
